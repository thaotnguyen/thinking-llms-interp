...
# python generate_responses.py --model qwen/Qwen2.5-1.5B --save_every 1 --max_tokens 1000 --is_base_model
...
python generate_responses.py --model Qwen/QwQ-32B --save_every 1 --max_tokens 1000